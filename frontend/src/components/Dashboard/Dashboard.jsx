...
const Dashboard = ({ user, onLogout }) => {
  ...
  const { products, loading: pLoading, addProduct, editProduct, removeProduct } = useProducts();
...
export default Dashboard;      await addReport(data);
    }
    setShowWasteForm(false);
    setEditingReport(null);
  };
  ...
  return (
    <div className="dashboard">
      ...
      <main className="dashboard-content">
        ...
        {activeTab === 'expiry' && (
          <ExpiryDashboard products={products} loading={pLoading} />
        )}
        {activeTab === 'waste' && (
          <WasteReportList
            reports={reports}
